...
variables <- c("GDPC1","PCECC96","GPDIC1","GCEC1","IPDBS","RCPHBS",
               ...
               "CPIAUCSL","PCEPI","CPITRNSL","DSERRG3M086SBEA","MZMSL","TOTRESNS","BUSLOANS","NONREVSL",
               "INDPRO","IPDMAT","RPI","IPBUSEQ","W875RX1","DPCERA3M086SBEA","USTPU",	"CE16OV",	"CLF16OV", 
               "FEDFUNDS","TB3MS","gs5","gs10","TB6MS","UNRATE")
out <- list()
...
variables1 <- c("CPIAUCSL","PCEPI","CPITRNSL","DSERRG3M086SBEA","MZMSL","TOTRESNS","BUSLOANS","NONREVSL", #tcode 6
               "INDPRO","IPDMAT","RPI","IPBUSEQ","W875RX1","DPCERA3M086SBEA","USTPU",	"CE16OV",	"CLF16OV", #tcode 5
               "FEDFUNDS","TB3MS","gs5","gs10","TB6MS","UNRATE", #tcode 2
               "sp", #tcode 5
